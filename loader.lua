...
elseif game.PlaceId == 10893141806 then
    loadstring(game:HttpsGet("https://raw.githubusercontent.com/yodieware/yodieware/main/games/truck_tycoon.lua"))()
elseif game.PlaceId == 7305309231 then
    loadstring(game:HttpsGet("https://raw.githubusercontent.com/yodieware/yodieware/main/games/taxi_boss.lua"))()
